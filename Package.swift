...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "Agoraffmpeg",
            url: "https://download.agora.io/swiftpm/AgoraRtcEngine_iOS/4.0.0-alpha.1/Agoraffmpeg.xcframework.zip",
            checksum: "4423156be350a15b17eb947153c88dae5351f6c8f7a161d89ed3ab3d01456c7d"
        ),
        .binaryTarget(
            name: "AgoraRtcCryptoLoader",
            url: "https://download.agora.io/swiftpm/AgoraRtcEngine_iOS/4.0.0-alpha.1/AgoraRtcCryptoLoader.xcframework.zip",
            checksum: "999e10c0d4f467dfcb3b15102903746452ac4ca7a7d0b577c9e543cae433b0f3"
        ),
        .binaryTarget(
            name: "AgoraRtcKit",
            url: "https://download.agora.io/swiftpm/AgoraRtcEngine_iOS/4.0.0-alpha.1/AgoraRtcKit.xcframework.zip",
            checksum: "a22a04681d3f5c528d1959345cd0eac7f3844defe9cc7e902b36c352eef7fb0c"
        ),
        .binaryTarget(
            name: "AgoraVideoProcess",
            url: "https://download.agora.io/swiftpm/AgoraRtcEngine_iOS/4.0.0-alpha.1/AgoraVideoProcess.xcframework.zip",
